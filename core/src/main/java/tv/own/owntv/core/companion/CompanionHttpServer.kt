 ...
 * HanTV-themed form (Xtream / M3U / Stalker) that any device on the same Wi-Fi can open.
 *
 * ## Security model
...
class CompanionHttpServer(
    ...
    private suspend fun handleClient(client: Socket) {
        client.use { socket ->
            ...
            // --- local sync (LOCAL_SYNC mode) — no web page: the other HanTV app talks here directly.
