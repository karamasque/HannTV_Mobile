 ...
 *  - [BACKUP_RESTORE] — an upload page the remote device uses to send an HanTV backup JSON to the TV;
 ...
 *  - [LOCAL_SYNC] — the only mode with no web page behind it: the other HanTV app on the same Wi-Fi
