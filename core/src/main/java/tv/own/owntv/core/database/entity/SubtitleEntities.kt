...
data class SubtitleCacheEntity(
    ...
    val fileName: String,
    /** Absolute path of the managed copy in HanTV's subtitle cache dir. */
 ...
 * DB v16. This is what lets HanTV re-list a title's downloaded subtitles on replay and drive the
