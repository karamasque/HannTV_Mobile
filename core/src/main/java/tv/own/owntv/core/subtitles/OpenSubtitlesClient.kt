...
/**
 * OpenSubtitles REST client (subtitle plan Part B Phase 1). All calls go through the HanTV
...
class OpenSubtitlesClient(
    ...
    private val clientId: tv.own.owntv.core.metadata.HanTVClientId,
    ...
    companion object {
        ...
        private const val USER_AGENT = "HanTV"
