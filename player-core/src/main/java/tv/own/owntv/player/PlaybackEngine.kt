...
/**
 * What the player HUD needs from "whichever engine is currently playing" — mpv ([HanTVPlayer], via
...
/** Adapts the full mpv player to [PlaybackEngine] (delegation only — keeps [HanTVPlayer] untouched). */
class MpvPlaybackEngine(private val p: HanTVPlayer) : PlaybackEngine {
