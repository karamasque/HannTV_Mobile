...
/** Typed playback failures. Fixed HanTV wording is resolved by the Compose HUD; raw provider/engine text stays raw. */
sealed interface PlaybackFailure {
    ...
    /** Fixed mpv diagnostics produced by HanTV, not provider text; resolve at the UI boundary. */
...
object PlayerErrors {
     ...
     * opening a new channel." has already said the useful thing. Fixed HanTV wording stays semantic
